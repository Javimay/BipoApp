package com.bipo.javier.bipo.info.activities;
...
import com.bipo.javier.bipo.info.fragments.BipoInfoFragment;
import com.bipo.javier.bipo.info.fragments.BipoTutorialFragment;
...
public class InfoBipoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TvTutorial){
            ...
            ft.add(R.id.RlyEvents,tutorialFragment).commit();
        }
    }
}
